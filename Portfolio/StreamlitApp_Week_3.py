...
MODEL_INFO = {
        ...
        "keys": ["AMZN", "AAPL", "INTL", "WBD", "DEXJPUS", "DEXUSUK","SP500", "DJIA", "VIXCLS"],
        "inputs": [{"name": k, "type": "number", "min": -1.0, "max": 1.0, "default": 0.0, "step": 0.01} for k in ["AMZN", "AAPL", "INTL", "WBD", "DEXJPUS", "DEXUSUK","SP500", "DJIA", "VIXCLS"]]
}
